...
from trip_service.solution.src.exceptions import UserNotLoggedInException
from trip_service.solution.src.service import TripService
...
from trip_service.solution.tests.in_memory_trip_repository import InMemoryTripRepository
